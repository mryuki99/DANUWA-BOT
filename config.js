...
const defaultConfig = {
  SESSION_ID: "PIxwQAJZ#NO76pSmEUd4PeyXT1QjVz8lrMbNqr7bZ7Nm7VK-Raj8", // Put your session id here
  ALIVE_IMG: "https://ibb.co/zzggtW9",
  ALIVE_MSG: "*Hello👋 YUKI Is Alive Now😍*", // Change alive msg from here
  ...
  BOT_OWNER: "94761701059", // Replace your bot owner number here with 94(country code)
  ownerNumber: ["94761701059"], // Replace your bot owner number here (same as bot owner number)
